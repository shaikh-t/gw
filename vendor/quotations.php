...
<head>
  ...
  <title>Quotations — GlobalWays Vendor</title>
  ...
  <div class="dashboard-wrapper d-flex">
    <aside class="dashboard-sidebar d-flex flex-column">
      ...
      <nav class="nav flex-column p-3 gap-1 flex-grow-1">
        ...
        <a class="nav-link active" href="quotations.php"><i class="bi bi-file-earmark-richtext"></i> Quotations</a>
    ...
    <div class="dashboard-main">
      ...
      <main class="p-4 p-lg-5">
        <div class="mb-4"><h1 class="font-serif h2 mb-1">Quotation Builder</h1><p class="text-muted mb-0">Create and send custom quotations to leads</p></div>
        <div class="row g-4">
          <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
              <div class="card-header bg-white border-bottom"><h2 class="h6 mb-0">New Quotation</h2></div>
              <div class="card-body">
                <div class="alert alert-info">Quotation builder is coming soon.</div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
              <div class="card-header bg-white border-bottom"><h3 class="h6 mb-0">Recent Quotations</h3></div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item small text-muted">No recent quotations.</li>
              </ul>
            </div>
          </div>
        </div>
