...
if ($role === 'admin_with_permission') {
    ...
    $_SESSION['mock_permissions'] = ['dashboard.view', 'cache.clear', 'manage_system_analytics', 'view_voice_telemetry', 'manage_bot_steps', 'view_bot_interaction_logs', 'can_view_failed_queries'];
