...
<head>
  ...
  <title>Dashboard — GlobalWays Customer</title>
...
<body class="bg-warm">
  <div class="dashboard-wrapper d-flex">
    <aside class="dashboard-sidebar d-flex flex-column">
      <div class="p-3 border-bottom border-secondary border-opacity-25 d-flex align-items-center justify-content-between">
        <a href="../index.php" class="text-decoration-none d-flex align-items-center gap-2">
          ...
          <div>
            <div class="text-white font-serif small">GlobalWays</div>
            <div class="font-mono text-uppercase" style="font-size:9px;letter-spacing:.15em;color:rgba(255,255,255,.4)">Customer Portal</div>
          </div>
        </a>
    ...
    <div class="dashboard-main">
      ...
      <main class="cp-page">
        <h1 class="cp-page-title"><span class="text-gradient-blue">Welcome</span> Back!</h1>
        <p class="cp-page-sub">Here's what's happening with your applications</p>
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-5">
            <div class="cp-section-head">
              <h2 class="cp-section-title">Recent Activity</h2>
            </div>
            <div class="cp-activity">
              <span class="cp-activity-icon"><i class="bi bi-arrow-left-right"></i></span>
              <div>
                <p class="cp-activity-text">Golden Visa application moved to Medical Test stage</p>
                <p class="cp-activity-time">2 hours ago</p>
              </div>
            </div>
            <div class="cp-activity">
              <span class="cp-activity-icon"><i class="bi bi-chat-dots"></i></span>
              <div>
                <p class="cp-activity-text">New message from Emirates Pro Services</p>
                <p class="cp-activity-time">5 hours ago</p>
              </div>
            </div>
            <div class="cp-activity">
              <span class="cp-activity-icon"><i class="bi bi-check-circle"></i></span>
              <div>
                <p class="cp-activity-text">Passport copy approved</p>
                <p class="cp-activity-time">1 day ago</p>
              </div>
            </div>
            <div class="cp-activity">
              <span class="cp-activity-icon"><i class="bi bi-credit-card"></i></span>
              <div>
                <p class="cp-activity-text">Payment of AED 2,500 received</p>
                <p class="cp-activity-time">3 days ago</p>
              </div>
            </div>
          </div>
        </div>
